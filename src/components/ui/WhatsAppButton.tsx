...
export default function WhatsAppButton({ whatsapp }: { whatsapp?: string }) {
  ...
  return (
    ...
    >
      ...
      {/* WhatsApp SVG */}
      <svg viewBox="0 0 32 32" width="32" height="32" fill="white" style={{ flexShrink: 0, position: 'relative' }}>
      ...
      {hovered && (
        <span style={{ color: 'white', fontWeight: 700, fontSize: '15px', whiteSpace: 'nowrap', position: 'relative' }}>
          Chat with us
        </span>
      )}
